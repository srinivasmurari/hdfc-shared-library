        ...
        try {
            ...
            withCredentials([
                    [$class          : 'UsernamePasswordMultiBinding',
                     credentialsId   : "bb-darshan",
                     usernameVariable: 'scmUser',
                     passwordVariable: 'scmPassword'],
                    [$class          : 'UsernamePasswordMultiBinding',
                     credentialsId   : "bitbucket-oauth-cred",
            ...
            dir("${projectName}-${teamName}-${artifactId}") {
                ...
                switch (operation) {
                    case "release-create":
                        branchManagerService.createRelease(params.teamName, params.projectName, params.artifactId)
                        break
                    case "release-close":
                        branchManagerService.finishRelease(params.teamName, params.projectName, params.artifactId)
                        break
                    case "release-candidate-create":
                        branchManagerService.createReleaseCandidate(params.teamName, params.projectName, params.artifactId)
                        break
                    case "feature-create":
                        branchManagerService.createFeature(params.feature, params.teamName, params.projectName, params.artifactId)
                        break
                    case "feature-close":
                        branchManagerService.finishFeature(params.feature, params.teamName, params.projectName, params.artifactId)
                        break
                    case "hotfix-create":
                        branchManagerService.createHotFix(params.teamName, params.projectName, params.artifactId)
                        break
                    case "hotfix-close":
                        branchManagerService.finishHotFix(params.teamName, params.projectName, params.artifactId)
                        break
                    default:
